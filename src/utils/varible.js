...
export const optionOutput = [
    ...
    {name: "Бронирование", value: "booking"},
]
export const optionReporting = [
    {name: "Отчет по бронированию", value: "reporting-booking"},
]
...
export const optionPayBookingCorp = [
    {
        id: 0,
    ...
    {
        id: 1,
        name: "Корпоративной картой в момент бронирования",
        value: "corpCard",
    },
];
