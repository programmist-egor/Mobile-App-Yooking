...
import {dateFormater, getFutureDate, getFutureMonthDate, monthText} from "../utils/dataFormater";
...
const hotels_item = createSlice({
    ...
    initialState: {
        ...
        cityOrHotel: {
            ...
            dataRange:{checkIn: new Date().getDate(), checkOut: getFutureDate(2), month: monthText(new Date().getMonth()) + "" + getFutureMonthDate(2), countNight: 2},
            guest: {adult: 1, child: []},
            checkIn: dateFormater(new Date()),
            checkOut: dateFormater(new Date(new Date().setDate(getFutureDate(2)))),
        },
        checkIn: "",
        checkOut: "",
